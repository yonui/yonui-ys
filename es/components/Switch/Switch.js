...
var SwitchAdapter = /*#__PURE__*/function (_Component) {
  _inherits(SwitchAdapter, _Component);

  var _super = _createSuper(SwitchAdapter);
  ...
  function SwitchAdapter() {
    ...
    _defineProperty(_assertThisInitialized(_this), "switchChildren", function (checked) {
  ...
  _createClass(SwitchAdapter, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          other = _objectWithoutProperties(_this$props, ["size"]);
