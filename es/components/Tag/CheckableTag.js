...
var CheckableTag = /*#__PURE__*/function (_Component) {
  ...
  function CheckableTag(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClick", function () {
      _this.props.onChange && _this.props.onChange.call(null, !_this.props.checked);
    });
  ...
  _createClass(CheckableTag, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          other = _objectWithoutProperties(_this$props, ["children", "checked", "className"]);

      var cls = classnames('u-tag-checkable', {
        'u-tag-checkable_checked': checked
      }, className);
